...
from orca.gateway.packets import OPCode, RECV, SEND
from orca.gateway.events import GatewayEvent
from orca.gateway.encoding import ENCODERS
from orca.util.websocket import Websocket
...
class GatewayClient(LoggingClass):
    ...
    def request_guild_members(
        ...
        """
        Request a batch of Guild members from orcard. Generally this function
        can be called when initially loading Guilds to fill the local member state.
        """
        self.send(
            OPCode.REQUEST_GUILD_MEMBERS,
            {
                # This is simply unfortunate naming on the part of orcard...
    ...
    def request_guild_members_by_id(
        ...
        """
        Request a batch of Guild members from orcard by their snowflake(s).
        """
        self.send(
            OPCode.REQUEST_GUILD_MEMBERS,
            {
                ...
                "limit": limit,
                "presences": presences,
                # This is simply even more unfortunate naming from orcard...
