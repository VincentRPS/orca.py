...
from orca.bot.command import Command, CommandError


# Contains a list of classes which will be excluded when auto orcavering plugins
...
class Plugin(LoggingClass, PluginDeco):
    ...
    def register_command(self, func, *args, **kwargs):
        ...
        func : function
            The function to be registered.
        args
            Arguments to pass onto the :class:`orca.bot.command.Command` object.
        kwargs
            Keyword arguments to pass onto the :class:`orca.bot.command.Command`
            object.
        """
