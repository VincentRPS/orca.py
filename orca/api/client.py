...
from orca.api.http import Routes, HTTPClient, to_bytes
from orca.util.functional import optional
from orca.util.logging import LoggingClass
from orca.util.sanitize import S
from orca.types.user import User
from orca.types.message import Message
from orca.types.oauth import Application, Connection
...
from orca.types.channel import Channel
from orca.types.invite import Invite
from orca.types.voice import VoiceRegion
from orca.types.webhook import Webhook
...
class APIClient(LoggingClass):
    """
    An abstraction over a :class:`orca.api.http.HTTPClient`, which composes
    ...
    ----------
    token : str
        The orcard authentication token (without prefixes) to be used for all
        HTTP requests.
    client : Optional[:class:`orca.client.Client`]
        The orca client this APIClient is a member of. This is used when constructing
        and fitting models from response data.

    Attributes
    ----------
    client : Optional[:class:`orca.client.Client`]
        The orca client this APIClient is a member of.
    http : :class:`orca.http.HTTPClient`
