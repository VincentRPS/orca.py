from orca.types.base import SlottedModel, Field, datetime, enum
from orca.types.user import User
from orca.types.guild import Guild
...
class Invite(SlottedModel):
    ...
    target_user : :class:`orca.types.user.User`
    ...
    inviter : :class:`orca.types.user.User`
    ...
    @property
    def link(self):
        return "https://orcard.gg/{}".format(self.code)
