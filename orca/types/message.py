...
from orca.types.channel import ChannelType
...
class Emoji(SlottedModel):
    """
    Represents either a standard or custom orcard emoji.
...
class MessageEmbedFooter(SlottedModel):
    ...
    proxy_icon_url : str
        A proxy URL for the footer icon, set by orcard.
    """
...
class MessageEmbedImage(SlottedModel):
    ...
    proxy_url : str
        A proxy URL for the image, set by orcard.
    width : int
        The width of the image, set by orcard.
    height : int
        The height of the image, set by orcard.
    """
...
class MessageEmbedThumbnail(SlottedModel):
    ...
    url : str
        The thumbnail URL.
    proxy_url : str
        A proxy URL for the thumbnail, set by orcard.
    width : int
        The width of the thumbnail, set by orcard.
    height : int
        The height of the thumbnail, set by orcard.
    """
...
class MessageEmbedVideo(SlottedModel):
    ...
    width : int
        The width of the video, set by orcard.
    height : int
        The height of the video, set by orcard.
    """
...
class MessageEmbedAuthor(SlottedModel):
    ...
    proxy_icon_url : str
        A proxy URL for the authors icon, set by orcard.
    """
...
class Message(SlottedModel):
    """
    Represents a Message created within a Channel on orcard.
    ...
    type : `MessageType`
        Type of the message.
    author : :class:`orca.types.user.User`
