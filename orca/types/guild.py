...
from orca.api.http import APIException
from orca.util.paginator import Paginator
from orca.util.snowflake import to_snowflake
...
from orca.types.user import User
from orca.types.voice import VoiceState
from orca.types.channel import Channel, ChannelType
from orca.types.message import Emoji
from orca.types.permissions import PermissionValue, Permissions, Permissible
...
class GuildEmoji(Emoji):
    ...
    @property
    def url(self):
        return "https://cdn.orcardapp.com/emojis/{}.{}".format(
...
class Role(SlottedModel):
    ...
    permissions : :class:`orca.types.permissions.PermissionsValue`
...
class GuildMember(SlottedModel):
    ...
    def get_voice_state(self):
        ...
        Returns
        -------
        Optional[:class:`orca.types.voice.VoiceState`]
    ...
    def orcannect(self):
        """
        orcannects the member from voice (if they are connected).
        """
...
class Guild(SlottedModel, Permissible):
    ...
    channels : dict(snowflake, :class:`orca.types.channel.Channel`)
    ...
    voice_states : dict(str, :class:`orca.types.voice.VoiceState`)
    ...
    def get_permissions(self, member):
        ...
        Returns
        -------
        :class:`orca.types.permissions.PermissionValue`
    ...
    def get_voice_state(self, user):
        ...
        Returns
        -------
        :class:`orca.types.voice.VoiceState`
    ...
    def get_icon_url(self, still_format="webp", animated_format="gif", size=1024):
        ...
        if self.icon.startswith("a_"):
            return "https://cdn.orcardapp.com/icons/{}/{}.{}?size={}".format(
    ...
    def get_vanity_url(self):
        ...
        return "https://orcard.gg/" + self.vanity_url_code

    def get_splash_url(self, fmt="webp", size=1024):
        if not self.splash:
            return ""

        return "https://cdn.orcardapp.com/splashes/{}/{}.{}?size={}".format(
    ...
    def get_banner_url(self, fmt="webp", size=1024):
        ...
        return "https://cdn.orcardapp.com/banners/{}/{}.{}?size={}".format(
