from orca.types.base import SlottedModel, Field, ListField, snowflake, text, enum
from orca.types.guild import Integration
...
class Application(SlottedModel):
    ...
    def get_icon_url(self, fmt="webp", size=1024):
        ...
        return "https://cdn.orcardapp.com/app-icons/{}/{}.{}?size={}".format(
